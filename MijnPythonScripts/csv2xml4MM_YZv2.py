...
#v2 = add console based run option functionality with argparse with help usage display
...
#csvFile = 'myDataINIT.csv'
#xmlFile = 'myDataINIT.xml'
csvFile = 'Replication_201411.csv'
xmlFile = 'Replication_201411.xml'
